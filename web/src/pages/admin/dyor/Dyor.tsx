...
const Dyor: React.FC<DyorProps> = (props: DyorProps) => {
  ...
  return (
    <Container>
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    How much of the supply do the top wallets own? (TODO: find where to get this
                    data)
                  </li>
                </ul>
              </li>
                ...
                <ul>
                  ...
                  <ul>
                    <li>
                      ...
                      founders, there might not be enough motivation to build a successful
                      chain/coin or token.
                    </li>
                    <li>
            ...
            <ul>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Check blogs of the VCs to see if there are posts regarding the investment and
              ...
              <li>
                Analysts to track (article writers, reddit posters, etc. who are dialed-in to
                project)
              </li>
      ...
      <div>
        <h3>WTD?</h3>
        Interested in a coin, considering a position, and then the price jumps signficantly?
        <br />
        Reset. Don't FOMO, but don't write off the idea of buying due to regret of not doing so
        earlier. Re-evaluate the project's value relative to other coins. Where <i>should</i> this
        project be ranked?
      </div>
    </Container>
  );
